...
public class RadioButtonDrawable extends Drawable implements Animatable {
	...
	private void drawChecked(Canvas canvas){
		...
		if(isRunning()){
			...
			if(mAnimProgress < inTime){
				...
				mPaint.setColor(Util.getMiddleColor(mPrevColor, mCurColor, inProgress));
	...
	public static class Builder{
		...
		public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
			...
			width(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_radiobutton_width, Util.convertDpToPx(context, 32)));
			height(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_radiobutton_height, Util.convertDpToPx(context, 32)));
			strokeSize(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_radiobutton_strokeSize, Util.convertDpToPx(context, 2)));
			radius(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_radiobutton_radius, Util.convertDpToPx(context, 10)));
			innerRadius(a.getDimensionPixelSize(R.styleable.RadioButtonDrawable_radiobutton_innerRadius, Util.convertDpToPx(context, 5)));
			strokeColor(a.getColorStateList(R.styleable.RadioButtonDrawable_radiobutton_strokeColor));
			animDuration(a.getInt(R.styleable.RadioButtonDrawable_radiobutton_animDuration, context.getResources().getInteger(android.R.integer.config_mediumAnimTime)));
