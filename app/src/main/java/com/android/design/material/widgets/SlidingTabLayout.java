...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int mTabTextViewSize = TAB_VIEW_TEXT_SIZE_SP;
    ...
    /** Set the custom layout to be inflated for the tab views. layoutResId Layout id to be inflated
     * textViewId id of the {@link android.widget.TextView} in the inflated view **/
