...
public class GoogleMaterialFonts implements ITypeface {
	
	private static final String TAG = "GoogleMaterialFonts";
    private final String TTF_FILE = "google_material_design.ttf";
    ...
    public HashMap<String, Character> getCharacters() {
        if (mChars == null) {
            final HashMap<String, Character> aChars = new HashMap<String, Character>();
    ...
    public static enum Icon implements IIcon {
        ...
        public ITypeface getTypeface() {
            if (typeface == null) {
                typeface = new GoogleMaterialFonts();
            }
            return typeface;
        }
    }
